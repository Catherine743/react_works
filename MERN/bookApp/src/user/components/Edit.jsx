        ...
        <div className="bg-white h-full w-90 z-50 fixed top-0 left-0">
          ...
          <div className="flex justify-center items-center flex-col my-5">
            <label htmlFor="userProfile">
              ...
              <img className='z-52' style={{ width: '100px', height: '100px', borderRadius: '50%' }} src="https://cdn1.iconfinder.com/data/icons/interaction-18/70/profile__account__user__upload__male-1024.png" alt="profile" />
